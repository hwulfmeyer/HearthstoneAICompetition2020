...
namespace SabberStoneBasicAI.AIAgents.PredatorMCTS
{
	public class OptionNode
	{
		...
		public OptionNode(OptionNode parent, Game game, int playerId, PlayerTask playerTask, Score.Score scoring)
		{
			_parent = parent;
		...
		public static List<OptionNode> GetSolutions(Game game, int playerId, Score.Score scoring, int maxDepth, int maxWidth)
		{
